  ...
  group('TalkCard', () {
    ...
    testWidgets('should display talk title', (tester) async {
      await tester.pumpWidget(createTestWidget(
        talk: createTalk(title: 'My Awesome Talk'),
      ));
    ...
    testWidgets('should display venue chip when not empty', (tester) async {
      await tester.pumpWidget(createTestWidget(
        talk: createTalk(venue: 'Room 101'),
      ));
    ...
    testWidgets('should display duration chip when not empty', (tester) async {
      await tester.pumpWidget(createTestWidget(
        talk: createTalk(duration: '30 min'),
      ));
    ...
    testWidgets('should not display chips when values are empty', (tester) async {
      await tester.pumpWidget(createTestWidget(
        talk: createTalk(track: '', venue: '', duration: ''),
      ));
    ...
    testWidgets('should display speaker chip with Chip widget when image provided', (tester) async {
    ...
    testWidgets('should display default avatar icon when no image', (tester) async {
      await tester.pumpWidget(createTestWidget(
        talk: createTalk(
          speakers: const [
            Speaker(name: 'John Doe', image: ''),
    ...
    testWidgets('should not display live link section when empty', (tester) async {
      await tester.pumpWidget(createTestWidget(
        talk: createTalk(liveLink: ''),
      ));
    ...
    testWidgets('should display all information for a complete talk', (tester) async {
      await tester.pumpWidget(createTestWidget(
        talk: createTalk(
          title: 'Complete Talk',
    ...
    testWidgets('should show CircleAvatar with NetworkImage when speaker has image URL', (tester) async {
      // This test verifies the structure exists, but doesn't load the actual network image
      await tester.pumpWidget(createTestWidget(
        talk: createTalk(
          speakers: const [
            Speaker(name: 'John Doe', image: ''), // Using empty to avoid network calls
          ],
        ),
      ));
