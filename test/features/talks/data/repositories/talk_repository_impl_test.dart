...
void main() {
  ...
  setUpAll(() {
    registerFallbackValue(TalkModel(
      date: DateTime.now(),
      title: '',
      description: '',
      speakers: const [],
  ...
  group('TalkRepositoryImpl', () {
    ...
    group('getTalks', () {
      ...
      test('should return list of talks on success', () async {
        when(() => mockDataSource.getTalks(eventId))
    ...
    group('createTalk', () {
      ...
      test('should return created talk on success', () async {
        when(() => mockDataSource.createTalk(eventId, any()))
    ...
    group('updateTalk', () {
      ...
      test('should return updated talk on success', () async {
        when(() => mockDataSource.updateTalk(eventId, any()))
    ...
    group('deleteTalk', () {
      ...
      test('should return Right(null) on success', () async {
        when(() => mockDataSource.deleteTalk(eventId, talkId))
            .thenAnswer((_) async {});
    ...
    group('batchUploadTalks', () {
      ...
      test('should create new talks when they do not exist', () async {
        when(() => mockDataSource.findTalkByTitleAndDate(eventId, any(), any()))
      ...
      test('should skip rows with ServerException and continue', () async {
        when(() => mockDataSource.findTalkByTitleAndDate(eventId, 'Talk 1', any()))
            .thenThrow(const ServerException('Error finding talk'));
        when(() => mockDataSource.findTalkByTitleAndDate(eventId, 'Talk 2', any()))
            .thenAnswer((_) async => null);
        when(() => mockDataSource.createTalk(eventId, any()))
